// core/BridgeOChart.js — cria e atualiza um Chart.js com cursor e sinais
var BridgeOChart = (function(){
  ...
  function setCursor(chart, index, price){
    const ds = chart.data.datasets[1]; // Cursor
    ds.data = [{ x:index, y:price }];
    chart.update('none');
  }
