...
render() {
  ...
  updateView() {
    ...
    if (this.currentStrategy) {
      document.getElementById("strategyName").textContent = this.currentStrategy.name || "Estratégia Sem Nome";
      document.getElementById("strategyDescription").textContent = this.currentStrategy.description || "";
      
      // Atualiza parâmetros na sidebar
      if (this.currentStrategy.params) {
        document.getElementById("orderSize").value = this.currentStrategy.params.orderSize || 1;
        document.getElementById("commission").value = this.currentStrategy.params.commission || 0.001;
        document.getElementById("slippage").value = this.currentStrategy.params.slippage || 0.0005;
        document.getElementById("rsiPeriod").value = this.currentStrategy.params.rsiPeriod || 14;
      }
    }
